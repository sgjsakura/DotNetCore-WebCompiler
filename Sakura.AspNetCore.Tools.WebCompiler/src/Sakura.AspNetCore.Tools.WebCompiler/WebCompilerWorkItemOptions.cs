...
namespace Sakura.AspNetCore.Tools.WebCompiler
{
	...
	public class WebCompilerWorkItemOptions
	{
		...
		/// <returns>
		///     If the <paramref name="key" /> exists in the <see cref="Settings" /> and the value is the type
		///     <typeparamref name="T" />, return the value; otherwise, return <paramref name="defaultValue" />.
		/// </returns>
		...
		/// <summary>
		///     Get the directory for puting all output files. If this property is <c>null</c>, each output file will be put in the
		///     same directory of its input file.
		/// </summary>
